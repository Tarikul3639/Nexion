...
import { BotMessageSquare, Users, GraduationCap, Eye, LockKeyhole, Mail, EyeOff, Sparkles } from "lucide-react"
          ...
          <Card className="sm:shadow-md sm:border border-blue-500/20 pb-8 bg-neutral-900/50 shadow-xl shadow-blue-500/10">
            <CardHeader className="bg-[#131313]">
              <div className="text-center">
                ...
                <h1 className="text-2xl font-bold text-neutral-200">Sign in to your account</h1>
